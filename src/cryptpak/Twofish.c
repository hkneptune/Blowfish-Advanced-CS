...
typedef struct
{
	...
	// (apparently there's no legacy problem with this Twofish implementation,
	// since all the byte material is converted in little endian - the only
	// thing we have to make sure is that this is done properly, without
	// dirty typecasting)
